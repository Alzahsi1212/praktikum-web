        ...
        if (isset($_POST['simpan_button'])) {
            ...
            if (!$result) {
                ...
                <div class="alert alert-success" role="alert">
                    <i class="fa fa-check-circle"></i> Ubah data berhasil disimpan
                </div>
                <?php
            }
        }
    ...
    <div class="col">
        <div class="card px-3 py-3">
            <form action="" method="post">
                ...
                <div class="mb-3 mt-3">
                    <input class="form-check-input" type="radio" name="status_karyawan" id="KONTRAK" value="KONTRAK" <?php echo $kontrak_checked ?>>
                    <label class="form-check-label" for="KONTRAK">Kontrak</label>
                </div>
                <div class="mb-3 mt-3">
                    <input class="form-check-input" type="radio" name="status_karyawan" id="MAGANG" value="MAGANG" <?php echo $magang_checked ?>>
                ...
                <div class="mb-3 mt-3">
                    ...
                    $result_bagian = mysqli_query($conn, $selectSQLBagian);
