<div id="top" class="row mb-3">
    ...
    <div class="col">
        <a href="?page=pilihkaryawan" class="btn btn-primary float-end">
    ...
    <div class="col">
        ...
        <?php
            ...
            if (!$result || mysqli_num_rows($result) == 0) {
                echo '<meta http-equiv="refresh" content="0;url=?page=pilihkaryawan">';
            }
        ...
        <div class="card px-3">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    $result_bagian = mysqli_query($conn, $selectSQL);
                    if (!$result_bagian) {
                    ?>
                        <div class="alert alert-danger" role="alert"> <?php echo mysqli_error($conn) ?>
                        </div>
                        <?php
                        return;
                    }
                    if (mysqli_num_rows($result_bagian) == 0) {
                        ?>
                        <div class="alert alert-light" role="alert"> Data kosong
                        </div>
                        <?php
                        return;
                    }
